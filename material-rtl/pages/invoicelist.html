        ...
        <div class="col-xl-3 col-md-6 col-12 ">
              ...
              <div class="box-body">
                ...
                <div class="text-center my-2">
                  ...
                  <span class="text-muted">Re Generate Invoice</span>
                </div>
              </div>				
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 col-12">
              ...
              <div class="box-body">
                ...
                <div class="text-center my-2">
                  ...
                  <span class="text-muted">Overdue Payment Invoice</span>
                </div>
              </div>
				...
				<div class="box">
					...
					<div class="box-body">						
						<div class="table-responsive">
							<table id="example" class="table mt-0 table-hover no-wrap table-striped table-bordered" data-page-size="10">
								<thead>
									<tr>
