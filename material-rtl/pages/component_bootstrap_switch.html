...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Bootstrap Switch </title>
        ...
        <div class="col-12">
		  <div class="box">
            ...
            <div class="box-body res-tb-block">
				<div class="row">
					<div class="col-xl-2 col-12 mb-20">
					  <h4>Primary</h4>
					</div>
					<div class="col-xl-2 col-6 text-center mb-20">
		  ...
		  <div class="box">
            ...
            <div class="box-body res-tb-block">
				<div class="row">
					...
					<div class="col-sm-5 col-12 text-center mb-20">
