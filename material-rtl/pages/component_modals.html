...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Modals UI </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="callout callout-success">
        ...
        <a href="http://getbootstrap.com/docs/4.0/components/modal/">Bootstrap documentation</a>
      </div>
	  ...
	  <div class="row">
        <div class="col-12 col-lg-3">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Left Modal</h4>
            </div>
            <div class="box-body">
              <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-left">
                Launch demo modal
              </button>
        ...
        <div class="col-12 col-lg-3">			
		  <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Center Modal</h4>
            </div>
            <div class="box-body">
              <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-center">
                Launch demo modal
              </button>
        ...
        <div class="col-12 col-lg-3">			
		  <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Fill Modal</h4>
            </div>
            <div class="box-body">
              <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-fill">
                Launch demo modal
              </button>
        ...
        <div class="col-12 col-lg-3">			
		  <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Right Modal</h4>
            </div>
            <div class="box-body">
              <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-right">
                Launch demo modal
              </button>
        ...
        <div class="col-lg-4 col-12">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Large modal <code>Click on image</code></h4>
            </div>
            <div class="box-body">
        ...
        <div class="col-lg-4 col-12">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Medium model <code>Click on image</code></h4>
            </div>
            <div class="box-body">
              <!-- sample modal content -->
        ...
        <div class="col-lg-4 col-12">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Small model <code>Click on image</code></h4>
            </div>
            <div class="box-body">
              <!-- sample modal content -->
              <img src="../../images/model3.png" alt="default" data-toggle="modal" data-target=".bs-example-modal-sm" class="model_img img-fluid" />
            </div>
          </div>
        </div><!-- /.col -->
      </div><!-- /.row -->
  ...
  <div class="modal modal-info fade" id="modal-info">
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn btn-outline btn-white" data-dismiss="modal">Close</button>
			<button type="button" class="btn btn-outline btn-white float-right">Save changes</button>
		  </div>
		</div>
		<!-- /.modal-content -->
	  </div>
