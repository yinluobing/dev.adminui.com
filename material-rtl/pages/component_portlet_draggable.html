...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Draggable Portlets </title>
	...
	<!-- gridstack-->
	<link href="../../assets/vendor_components/gridstack/gridstack.css" rel="stylesheet"> 
      ...
      <div class="row">
        <div class="col-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
				<h3 class="box-title mt-0">Draggable Panel Portlets</h3> Thus is a widget layout jquery plugin.
...
<!-- ./wrapper -->
	...
	<script src="../js/pages/gridstackjs.js"></script>
