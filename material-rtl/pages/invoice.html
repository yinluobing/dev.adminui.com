...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Invoice </title>
    ...
    <section class="invoice printableArea">
      ...
      <div class="row invoice-info">
        <div class="col-md-6 invoice-col">
          <strong>From</strong>	
		  <address>
			<strong class="text-blue font-size-24">Superieur Admin</strong><br>
      ...
      <div class="row no-print">
        <div class="col-12">
          ...
          <button type="button" class="btn btn-danger pull-right mr-5">
