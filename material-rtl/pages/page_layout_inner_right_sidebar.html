			...
			<a class="mdi mdi-close mdi-menu btn btn-success open-left-block d-block d-md-none" href="javascript:void(0)"></a>
				<div class="scrollable" style="height: 100%;">
					<div class="left-content-area">
					  <div class="card mb-0">
						  <div class="card-body">			  	
							<img class="card-img-bottom img-responsive mb-25" src="../../images/card/img2.jpg" alt="Card image cap">            	
							<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-outline btn-primary btn-sm">Go somewhere</a>
						  </div>
					  </div>
						<hr>
					  <div class="card mb-0">
						<div class="card-header with-border">
							<h4 class="card-title">Latest Job Opning</h4>
						</div>
					  ...
					  <div class="card mb-0">
						  ...
						  <div class="card-content">
							<div class="card-body">
							  <form action="premade.html" method="post" onsubmit="return false;">					
								...
								<div class="form-group row">
									<label class="col-12" for="lock1-password1">Password</label>
									<div class="col-12">
										<input type="password" class="form-control" id="lock1-password1" name="lock1-password1" placeholder="Enter your password..">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-12">
										<label class="switch switch-border switch-info">
										  ...
										  <span class="switch-description"></span>&nbsp; Remember Me?
										</label>
									</div>
								</div>
