...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Advanced medias </title>
		...
		<div class="row">
			...
			<div class="col-xl-3 col-md-6 col-12">
			    <div class="media align-items-center bg-white mb-20">
				  ...
				  <div>
					<a class="btn btn-block btn-primary btn-sm" href="#">Follow</a>
				  </div>
				</div>				
			</div>		
			...
			<div class="col-xl-3 col-md-6 col-12">
			    <div class="media bg-white mb-20">
				  <img class="avatar" src="../../images/avatar3.png" alt="...">
				  <div class="media-body">
					<p><strong>Alexander</strong> <time class="float-right" datetime="2017-07-14 20:00">24 min ago</time></p>
			...
			<div class="col-xl-3 col-md-6 col-12">
			    <div class="media align-items-center bg-primary mb-20">
				  ...
				  <div class="media-body">
					<p><strong>Alexander</strong></p>
					<p class="text-white">@Alexander</p>
				  </div>
				  <div>
					<a class="btn btn-block btn-outline btn-white btn-sm" href="#">Follow</a>
				  </div>
				</div>				
			</div>		
			...
			<div class="col-xl-3 col-md-6 col-12">
				<div class="media align-items-center bg-info mb-20">
				  ...
				  <div>
					<button type="button" class="btn btn-box-tool text-white" data-toggle="tooltip" title="" data-original-title="More info"><i class="fa fa-info"></i></button>
				  </div>
				</div>				
			</div>		
			...
			<div class="col-xl-3 col-md-6 col-12">
			    <div class="media bg-danger mb-20">
				  <img class="avatar" src="../../images/avatar3.png" alt="...">
				  <div class="media-body">
					<p><strong>Alexander</strong> <time class="float-right text-white" datetime="2017-07-14 20:00">24 min ago</time></p>
			...
			<div class="col-xl-3 col-md-6 col-12">
			    <div class="media bg-white mb-20">
				  <div class="media-body">
					<p><strong>Alexander@gmail.com</strong></p>
					<p>Work</p>
				  </div>
			...
			<div class="col-xl-3 col-md-6 col-12">
			    <div class="media bg-danger-gradient mb-20">
				  <span class="fa fa-phone lead text-yellow"></span>
				  <div class="media-body">
			...
			<div class="col-xl-3 col-md-6 col-12">
			    <div class="media bg-info-gradient-animet mb-20">
				  <div class="media-body">
					<p class="text-white"><strong>Alexander@gmail.com</strong></p>
			    ...
			    <div class="media bg-white mb-20">
				  ...
				  <div class="media-body">
					...
					<div class="d-inline-block pull-right mt-10">
					  <button type="button" class="btn btn-success btn-xs m-5">Approve</button>
					  <button type="button" class="btn btn-danger btn-xs m-5">Delete</button>
					</div>
				  </div>
				</div>				
			</div>		
