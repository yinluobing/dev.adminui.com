...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Sweat Alert </title>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">A basic message</h3>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Title with a text under</h3>
               <p class="m-0">(Click on image)</p> 
            </div>
            <div class="box-body pad res-tb-block">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Alert with Image</h3>
               <p class="m-0">(Click on image)</p> 
            </div>
            <div class="box-body pad res-tb-block">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Alert with time</h3>
               <p class="m-0">(Click on image)</p> 
            </div>
            <div class="box-body pad res-tb-block">
