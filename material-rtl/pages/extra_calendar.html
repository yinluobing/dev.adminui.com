...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Calendar</title>
					  ...
					  <div class="card">
						...
						<div class="card-body p-0">
						  ...
						  <div id="external-events">
							...
							<div class="external-event m-15 bg-purple" data-class="bg-purple"><i class="fa fa-hand-o-right"></i>Work on UI design</div>
						  ...
						  <div class="event-fc-bt mx-15 my-20">
							...
							<a href="#" data-toggle="modal" data-target="#add-new-events" class="btn btn-lg btn-success btn-block my-10">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-white btn-danger" data-dismiss="modal">Close</button>
				</div>
			</div>
		</div>
	</div>
