...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  Notification </title>
		  ...
		  <div class="col-md-5 col-12">
			  <div class="row">	
				<div class="col-12">
				  <div class="box">
					<div class="box-header">
					  <h3 class="box-title">Simple Toastr Alerts</h3>
					   <p>You can use four different alert <code>info, warning, success, and error</code> message.</p>
					</div>
					<div class="box-body pad res-tb-block">
					  <div class="button-box">
							<button class="tst1 btn btn-info btn-block btn-rounded mb-15">Info Message</button>
							<button class="tst2 btn btn-warning btn-block btn-rounded mb-15">Warning Message</button>
							<button class="tst3 btn btn-success btn-block btn-rounded mb-15">Success Message</button>
							<button class="tst4 btn btn-danger btn-block btn-rounded mb-15">Danger Message</button>
						</div>              
					</div>
					<!-- /.box-body -->
				  </div>
					...
					<div class="box-body">
					  <div class="row">
							<div class="col-12">
								...
								<button class="btn btn-success btn-outline btn-rounded btn-sm showtop btn-block mb-15">Alert Top Full width</button>
								<!-- Start an Alert -->
							...
							<div class="col-12">
								...
								<button class="btn btn-danger btn-outline btn-rounded btn-sm showbottom btn-block mb-15">Alert Bottom Full width</button>
								<!-- Start an Alert -->
							...
							<div class="col-12">
								<h4>Alert Full top </h4>
								<button class="btn btn-info btn-outline btn-rounded btn-sm showtop2 btn-block mb-15">Alert Fullwidth Top with image</button>
								<!-- Start an Alert -->
							...
							<div class="col-12">
								...
								<button class="btn btn-warning btn-outline btn-rounded btn-sm showbottom2 btn-block mb-15">Alert Bottom Full width</button>
								<!-- Start an Alert -->
					...
					<div class="box-body">
					  <div class="row">
							<div class="col-12">
								...
								<button id="showtopright" class="btn btn-success btn-rounded btn-sm btn-block mb-15">Show Top Right</button>
								<!-- Start an Alert -->
							...
							<div class="col-12">
								...
								<button id="showtopleft" class="btn btn-danger btn-rounded btn-sm btn-block mb-15">Show Top Left</button>
								<!-- Start an Alert -->
							...
							<div class="col-12">
								...
								<button id="showbottomleft" class="btn btn-primary btn-rounded btn-sm btn-block mb-15">Show Bottom Left</button>
								<!-- Start an Alert -->
							...
							<div class="col-12">
								...
								<button id="showbottomright" class="btn btn-info btn-rounded btn-sm btn-block mb-15">Show Top Right</button>
								<!-- Start an Alert -->
